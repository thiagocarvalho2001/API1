...
async function main() {
  const recipe1 = await prisma.recipe.upsert({
    ...
    create: {
      ...
      ingredients:
        'Spaghetti, menci beef, tomato sauce, onions, garlic, olive oil, salt, pepper',
      instructions:
        '1. Cook the spaghetti. 2. Fry the minced beef. 3. Add the tomato sauce to the beef. 4. Serve the spaghetti with sauce.',
    },
  });
